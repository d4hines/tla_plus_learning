...
\* BEGIN TRANSLATION (chksum(pcal) = "44d8d3bd" /\ chksum(tla) = "4ab4c82f")
...
MyFirstTransition(self) == /\ pc[self] = "MyFirstTransition"
                           ...
                           /\ UNCHANGED << good_nodes, bad_nodes, nodes, round, 
                                           step, decision, lockedValue, 
...
\* Last modified Wed Dec 15 11:29:57 EST 2021 by d4hines
